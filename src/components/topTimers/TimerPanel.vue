        ...
        <v-container class="pt-0 px-0 pb-2">
            <v-expansion-panel>
                <v-expansion-panel-title>
                    <v-container class="d-flex justify-space-between align-center pa-0 ma-0">
                        ...
                        <v-container class="d-flex align-center pa-0 ma-0 w-auto">
                            ...
                            <v-btn :color="isPaused ? 'error' : 'secondary-darken-1'" :icon="isPaused ? 'mdi-play' : 'mdi-pause'"
                ...
                <v-expansion-panel-text>
                    ...
                    <span class="text-body-2">The settings for this timer will live here in the future. Just dream of it for now. Pretend it rules. Be excited.</span>
                </v-expansion-panel-text>
            </v-expansion-panel>
        </v-container>
    </v-expansion-panels>
